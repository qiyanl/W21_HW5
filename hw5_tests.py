...
class TestCard(unittest.TestCase):
    ...
    def test_q5(self):
        ...
        '''
        d5 = hw5_cards.Deck()
        isinstance(d5.deal_card(),hw5_cards.Card)
    ...
    def test_q7(self):
        ...
        '''
        d7 = hw5_cards.Deck()
        d7_len1 = len(d7.cards)
        d7.deal_card()
        d7_len2 = len(d7.cards)
        d7.replace_card(d7)
        d7_len3 = len(d7.cards)
        self.assertEqual(d7_len1,d7_len3,52)
        return (d7_len1,d7_len3,52)
